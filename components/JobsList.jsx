...
const JobsList = ({jobs, deleteJob, editJobPart1, greyedOut, resetter, nuke, nukeRelief}) => {
  return (
    <div id="JobsListSectionContainer">
      <div id="JobsListSection">
      ...
      <button id="cancelEdit" onClick={resetter}>Cancel edit</button>
    </div>
  )
}
